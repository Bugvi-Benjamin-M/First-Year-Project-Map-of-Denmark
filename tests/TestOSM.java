...
public class TestOSM {
  ...
  public void testBounds(){
      ...
      assertTrue(Math.abs(11.4692700 * OSMHandler.getLongitudeFactor() -
  model.getMinLongitude()) < 0.0001);
      assertTrue(Math.abs(-55.7286100 - model.getMaxLatitude()) < 0.0001);
      assertTrue(Math.abs(11.4735500 * OSMHandler.getLongitudeFactor() -
  model.getMaxLongitude()) < 0.0001);
  }*/
    /* @Test
